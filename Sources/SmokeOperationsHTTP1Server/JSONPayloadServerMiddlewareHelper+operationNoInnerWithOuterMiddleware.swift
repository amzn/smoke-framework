...
//
//  JSONPayloadServerMiddlewareHelper+operationNoInnerWithOuterMiddleware.swift
...
public extension JSONPayloadServerMiddlewareHelper {
    ...
    mutating func addHandlerForOperation<ResponseTransformOutputType: OperationHTTP1OutputProtocol,
          ...
          operation: @escaping @Sendable (RouterType.OutgoingInput, ApplicationContextType) async throws
          -> RouterType.OutputWriter.OutputType,
