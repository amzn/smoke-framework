...
//
// SmokeWithNoInputWithOutputOperationProviderTests.swift
...
private extension ExampleContext {
    @Sendable func successOperation() -> OutputHTTP1Attributes {
        return .init(bodyColor: .blue, isGreat: true, theHeader: "HEADER")
    }
    
    @Sendable func allowedFailureOperation() throws -> OutputHTTP1Attributes {
        throw TestErrors.allowedError
    }
    
    @Sendable func notAllowedFailureOperation() throws -> OutputHTTP1Attributes {
        throw TestErrors.notAllowedError
    }
}

class SmokeWithNoInputWithOutputOperationProviderTests: XCTestCase {
