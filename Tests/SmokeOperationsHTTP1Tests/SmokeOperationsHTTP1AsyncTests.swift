...
func handleExampleOperationVoidAsync(input _: ExampleInput, context _: ExampleContext,
                                     responseHandler: (Error?) -> Void) throws {
    responseHandler(nil)
}

func handleExampleHTTP1OperationVoidAsync(input: ExampleHTTP1Input, context _: ExampleContext,
                                          responseHandler: (Error?) -> Void) throws {
    input.validateForTest()
    responseHandler(nil)
}

func handleBadOperationVoidAsync(input _: ExampleInput, context _: ExampleContext,
                                 responseHandler: (Error?) -> Void) throws {
...
func handleBadHTTP1OperationVoidAsync(input: ExampleHTTP1Input, context _: ExampleContext,
                                      responseHandler: (Error?) -> Void) throws {
    input.validateForTest()
    let error = MyError.theError(reason: "Is bad!")
...
func handleBadOperationVoidAsyncWithThrow(input _: ExampleInput, context _: ExampleContext,
                                          responseHandler _: (Error?) -> Void) throws {
    throw MyError.theError(reason: "Is bad!")
}

func handleBadHTTP1OperationVoidAsyncWithThrow(input: ExampleHTTP1Input, context _: ExampleContext,
                                               responseHandler _: (Error?) -> Void) throws {
    input.validateForTest()
    throw MyError.theError(reason: "Is bad!")
}

func handleExampleOperationAsync(input: ExampleInput, context _: ExampleContext,
                                 responseHandler: (Swift.Result<OutputAttributes, Swift.Error>) -> Void) throws {
...
func handleExampleHTTP1OperationAsync(input: ExampleHTTP1Input, context _: ExampleContext,
                                      responseHandler: (Swift.Result<OutputHTTP1Attributes, Swift.Error>) -> Void) throws {
    input.validateForTest()
...
func handleBadOperationAsync(input _: ExampleInput, context _: ExampleContext,
                             responseHandler: (Swift.Result<OutputAttributes, Swift.Error>) -> Void) throws {
    let error = MyError.theError(reason: "Is bad!")
...
func handleBadHTTP1OperationAsync(input: ExampleHTTP1Input, context _: ExampleContext,
                                  responseHandler: (Swift.Result<OutputHTTP1Attributes, Swift.Error>) -> Void) throws {
    input.validateForTest()
    let error = MyError.theError(reason: "Is bad!")
...
func handleBadOperationAsyncWithThrow(input _: ExampleInput, context _: ExampleContext,
                                      responseHandler _: (Swift.Result<OutputAttributes, Swift.Error>) -> Void) throws {
    throw MyError.theError(reason: "Is bad!")
}

func handleBadHTTP1OperationAsyncWithThrow(input: ExampleHTTP1Input, context _: ExampleContext,
                                           responseHandler _: (Swift.Result<OutputHTTP1Attributes, Swift.Error>) -> Void) throws {
    input.validateForTest()
    throw MyError.theError(reason: "Is bad!")
}

private let handlerSelector: StandardSmokeHTTP1HandlerSelector<ExampleContext,
