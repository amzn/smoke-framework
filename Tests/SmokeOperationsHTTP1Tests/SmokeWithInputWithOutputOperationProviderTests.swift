...
class SmokeWithInputWithOutputOperationProviderTests: XCTestCase {
    ...
    func testSuccessNoInnerMiddlewareNoOuterMiddleware() async throws {
        ...
        let transformMiddleware = middlewareStack.getWithInputWithOutputJSONTransformingMiddleware(
            forOperationProvider: ExampleContext.successOperation, statusOnSuccess: .imATeapot)
        
        middlewareStack.addHandlerForOperation(.exampleGetOperationWithToken, httpMethod: .POST, operationProvider: ExampleContext.successOperation,
    ...
    func testAllowedFailureNoInnerMiddlewareNoOuterMiddleware() async throws {
        ...
        let transformMiddleware = middlewareStack.getWithInputWithOutputJSONTransformingMiddleware(
            forOperationProvider: ExampleContext.allowedFailureOperation, statusOnSuccess: .imATeapot)
        
        middlewareStack.addHandlerForOperation(.exampleGetOperationWithToken, httpMethod: .POST, operationProvider: ExampleContext.allowedFailureOperation,
                                               allowedErrors: [(TestErrors.allowedError, 404)],
                                               transformMiddleware: transformMiddleware)
    ...
    func testNotAllowedFailureNoInnerMiddlewareNoOuterMiddleware() async throws {
        ...
        let transformMiddleware = middlewareStack.getWithInputWithOutputJSONTransformingMiddleware(
            forOperationProvider: ExampleContext.notAllowedFailureOperation, statusOnSuccess: .imATeapot)
        
        middlewareStack.addHandlerForOperation(.exampleGetOperationWithToken, httpMethod: .POST,
    ...
    func testSuccessNoInnerMiddlewareWithOuterMiddleware() async throws {
        ...
        let transformMiddleware = middlewareStack.getWithInputWithOutputJSONTransformingMiddleware(
            from: outerMiddleware, forOperationProvider: ExampleContext.successOperation, statusOnSuccess: .imATeapot)
