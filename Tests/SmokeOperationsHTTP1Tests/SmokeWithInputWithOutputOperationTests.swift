...
//
// SmokeWithInputWithOutputOperationTests.swift
...
@Sendable private func successOperation(_ input: ExampleHTTP1Input, context: ExampleContext) -> OutputHTTP1Attributes {
...
@Sendable private func allowedFailureOperation(_ input: ExampleHTTP1Input, context: ExampleContext) throws -> OutputHTTP1Attributes {
    throw TestErrors.allowedError
}

@Sendable private func notAllowedFailureOperation(_ input: ExampleHTTP1Input, context: ExampleContext) throws -> OutputHTTP1Attributes {
    throw TestErrors.notAllowedError
}

class SmokeWithInputWithOutputOperationTests: XCTestCase {
    ...
    func testSuccessNoInnerMiddlewareNoOuterMiddleware() async throws {
        ...
        let transformMiddleware = middlewareStack.getWithInputWithOutputJSONTransformingMiddleware(
            forOperation: successOperation, statusOnSuccess: .imATeapot)
        
        middlewareStack.addHandlerForOperation(.exampleGetOperationWithToken, httpMethod: .POST, operation: successOperation,
        ...
        // the writer should be completed, with the success status but the response body
    ...
    func testAllowedFailureNoInnerMiddlewareNoOuterMiddleware() async throws {
        ...
        middlewareStack.addHandlerForOperation(.exampleGetOperationWithToken, httpMethod: .POST, operation: allowedFailureOperation,
                                               allowedErrors: [(TestErrors.allowedError, 404)],
                                               transformMiddleware: transformMiddleware)
    ...
    func testNotAllowedFailureNoInnerMiddlewareNoOuterMiddleware() async throws {
        ...
        middlewareStack.addHandlerForOperation(.exampleGetOperationWithToken, httpMethod: .POST, operation: notAllowedFailureOperation,
                                               allowedErrors: [(TestErrors.allowedError, 404)],
                                               transformMiddleware: transformMiddleware)
    ...
    func testSuccessNoInnerMiddlewareWithOuterMiddleware() async throws {
        ...
        let transformMiddleware = middlewareStack.getWithInputWithOutputJSONTransformingMiddleware(
            from: outerMiddleware, forOperation: successOperation, statusOnSuccess: .imATeapot)
    ...
    func testSuccessWithInnerMiddlewareNoOuterMiddleware() async throws {
        ...
        let innerMiddleware = MiddlewareStack {
            TestOriginalNoOuterMiddlewareInnerMiddleware<ExampleHTTP1Input, OutputHTTP1Attributes>(flag: originalMiddlewareFlag)
            
            TestTransformingNoOuterMiddlewareInnerMiddleware<ExampleHTTP1Input, OutputHTTP1Attributes>()
            
            TestTransformedNoOuterMiddlewareInnerMiddleware<ExampleHTTP1Input, OutputHTTP1Attributes>(flag: transformedMiddlewareFlag)
        }
        
        let transformMiddleware = middlewareStack.getWithInputWithOutputJSONTransformingMiddleware(
            to: innerMiddleware, statusOnSuccess: .imATeapot)
    ...
    func testSuccessWithInnerMiddlewareWithOuterMiddleware() async throws {
        ...
        let innerMiddleware = MiddlewareStack {
            TestOriginalInnerMiddleware<ExampleHTTP1Input, OutputHTTP1Attributes>(flag: originalInnerMiddlewareFlag)
            
            TestTransformingInnerMiddleware<ExampleHTTP1Input, OutputHTTP1Attributes>()
            
            TestTransformedInnerMiddleware<ExampleHTTP1Input, OutputHTTP1Attributes>(flag: transformedInnerMiddlewareFlag)
        }
        
        let transformMiddleware = middlewareStack.getWithInputWithOutputJSONTransformingMiddleware(
            from: outerMiddleware, to: innerMiddleware, statusOnSuccess: .imATeapot)
